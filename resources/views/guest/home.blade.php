...
<section class="home-sec-01">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12">
                <div class="text">
                    <p>NavyDaveGolf is here to help guide you to your best golf. On every professional tour, there are 100’s of different swings!</p>
        ...
        <div class="row align-items-center">
            <div class="col-lg-7 col-md-12">
                <div class="text">
                    ...
                    <p>Your goals, are OUR goals! Not everyone is trying to win the Masters. You may not even be worried about winning your club title. If you’re here, you do want to play better! NavyDaveGolf is here to help you to your specific goal!</p>
                    <div class="two-thing-aline">
                       <div class="btn-box">
                        <a href="#" class="t-btn">Schedule Meeting</a>
                       </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row ">
            <div class="col-lg-5 col-md-12">
                <div class="pricing-box">
                    <div class="pricing-box-content">
                        <h4>Petty Officer</h4>
                        <h5>$280</h5>
                        <p>A perfect session for any golfer regardless of age or proficiency!</p>
                    </div>
                    <div class="sessions-box">
                        <p><img src="assets/images/double-tick.png" alt="">04 Sessions Included</p>
            ...
            <div class="col-lg-7 col-md-12">
                <div class="text">
                    ...
                    <p>All lesson packages include a “before and after” video, showing you your progress from where you started to where you are now.</p>
                    <div class="two-thing-aline">
                       <div class="btn-box">
                        <a href="#" class="t-btn new">View All Packages <img src="assets/images/right-arrow.png" alt=""> </a>
                       </div>
                    </div>
                </div>
                <div class="pricing-box hot">
                    <div class="pricing-box-content ">
                        <h4>Cheif Petty Officer</h4>
                        <h5>$360</h5>
                        <p>Designed for the amateur that wants to lower his/her handicap.</p>
                        <div class="hot-box">
                            <img class="star" src="assets/images/hot-star.png" alt="">
                            <p>HOT</p>
                        </div>
                    </div>
                    <div class="sessions-box">
                        <p><img src="assets/images/double-tick.png" alt="">06 Sessions Included</p>
                        <a href="#" class="t-btn">Book Now</a>
                    </div>
