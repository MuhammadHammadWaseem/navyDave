...
<head>
    ...
    <link rel="icon" href="{{ url('/assets/images/favicon.png') }}" type="favicon.png" sizes="32x32">
...
<body>
            ...
            <div class="row align-items-center">
                <div class="col-lg-2">
                    <div class="header-logo">
                        <a href="index.html"><img src="{{ url('/assets/images/header-logo.png') }}"
                                alt=""></a>
                    </div>
                </div>
                <div class="col-lg-8">
                ...
                <div class="col-lg-2">
                    <div class="header-cart-search">
                        <ul>
                            <li><a href="#"><img src="{{ url('/assets/images/shopping-cart.png') }}"
                                        alt=""></a></li>
                            <li><a href="#"><img src="{{ url('/assets/images/search-icon.png') }}"
                                        alt=""></a></li>
                            <li><a href="#"><img src="{{ url('/assets/images/person-user.png') }}"
                                        alt=""></a></li>
                        </ul>
                    </div>
                </div>
    ...
    <script src="{{ url('/assets/js/wow-animate.js') }}"></script>
